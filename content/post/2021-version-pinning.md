...
Focusing on personal-code management vs external-code makes sense when the external code (e.g. Matlab) changes much less frequently than your internal code.
Matlab, where your personal code will change more than the
